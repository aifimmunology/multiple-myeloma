...
# %%
dir.create("../../../data/rna/pseudobulk/results/fgsea_all_results", recursive = TRUE, showWarnings = FALSE)
dir.create("../../../data/rna/pseudobulk/results/fgsea_all_pvals", recursive = TRUE, showWarnings = FALSE)
...
for (f in files) {
  ...
  fgsea_csv <- sub("^results/deseq2_results/deseq2_results_", "../../../data/rna/pseudobulk/results/fgsea_all_results/fgsea_all_results_", f)
  pval_png <- sub("^results/deseq2_results/deseq2_results_", "../../../data/rna/pseudobulk/results/fgsea_all_pvals/fgsea_all_results_", sub("\\.csv$", "_pvals.png", f))
  ...
  deg_result <- deg_result %>%
    mutate(rank_metric = ifelse(is.na(padj), NA, -log10(pvalue) * sign(log2FoldChange))) %>%
